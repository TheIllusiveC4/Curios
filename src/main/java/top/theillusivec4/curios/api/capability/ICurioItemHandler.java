...
public interface ICurioItemHandler {
  ...
  /**
   * A unmodifiable view of the map of the current curios, sorted by the
   ...
   * @return The {@link CurioStackHandler} associated with the given
   * {@link CurioType} identifier
   */
  ...
  /**
   * @param identifier The identifier for the {@link CurioType}
   * @param slot       The slot index of the {@link CurioStackHandler} for
  ...
  /**
   * Sets the ItemStack in the given slot index for the given {@link CurioType}
   * identifier.
   *
   * @param identifier The identifier for the {@link CurioType}
   * @param slot       The slot index of the {@link CurioStackHandler} for
  ...
  /**
   * Enables the {@link CurioType} for a given identifier, adding the default
   * settings to the curio map
   *
   * @param identifier The identifier for the {@link CurioType}
   */
  ...
  /**
   * Disables the {@link CurioType} for a given identifier, removing it from the
   * curio map.
   * Note that the default implementation handles catching and returning ItemStacks
   * that are found in these slots.
   *
   * @param identifier The identifier for the {@link CurioType}
   */
  ...
  /**
   * Adds an amount of slots to the {@link CurioStackHandler} of a {@link CurioType}
  ...
  /**
   * Removes an amount of slots from the {@link CurioStackHandler} of a {@link CurioType}
   * associated with the identifier.
   * Note that the default implementation handles catching and returning ItemStacks
   * that are found in these slots.
   *
  ...
  /**
   * The default curio map built from the settings found in {@link CuriosAPI},
   ...
   *
   * @return A list of disabled {@link CurioType} by identifier for this
   * handler
   */
  ImmutableSet<String> getDisabled();

  /**
   * Used internally for setting the list of disabled {@link CurioType} by
   ...
   * Used internally for storing items found in the process of disabling/removing
   * slots to be given back to the player or dropped on the ground in other cases.
   *
   ...
   * Used internally for dropping items found in disabling/removing slots or
   * giving them back to players.
   */
