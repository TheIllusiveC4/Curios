...
public interface ICurioItemHandler {
  ...
  /**
   * A unmodifiable view of the map of the current curios, sorted by the {@link CurioType}
   * identifier.
   *
  ...
  /**
   * Enables the {@link CurioType} for a given identifier, adding the default settings to the curio
   * map.
   *
   * @param identifier The identifier for the {@link CurioType}
   */
  ...
  /**
   * Disables the {@link CurioType} for a given identifier, removing it from the curio map. Note
  ...
  /**
   * The default curio map built from the settings found in {@link CuriosAPI}, sorted by {@link
   * CurioType} identifier. Used primarily for initializing and resetting the current curio map.
   *
  ...
  /**
   * Used internally for setting the list of disabled {@link CurioType} by identifier for this
   * handler.
   *
  ...
  /**
   * Adds an ItemStack to the invalid cache. Used internally for storing items found in the process
   * of disabling/removing slots to be given back to the player or dropped on the ground in other
   * cases.
   *
  ...
  /**
   * Drops all of the ItemStacks found in the invalid cache. Used internally for dropping items
   * found in disabling/removing slots or giving them back to players.
   */
